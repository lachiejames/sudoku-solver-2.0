...
final Reducer<HashMap<TileKey, TileState>> tileStateMapReducer =
  ...
  TypedReducer<HashMap<TileKey, TileState>, TileSelectedAction>(
      _tileSelectedReducer),
  TypedReducer<HashMap<TileKey, TileState>, TileDeselectedAction>(
      _tileDeselectedReducer),
  TypedReducer<HashMap<TileKey, TileState>, LoadPlayScreenWithSudokuAction>(
      _loadExampleValues),
  TypedReducer<HashMap<TileKey, TileState>, NumberPressedAction>(
      _addPressedNumberToTile),
  TypedReducer<HashMap<TileKey, TileState>, SudokuSolvedAction>(
      _updateTileMapWithSolvedSudokuReducer),
  TypedReducer<HashMap<TileKey, TileState>, RestartAction>(
      _clearAllValuesReducer),
  TypedReducer<HashMap<TileKey, TileState>, ChangeScreenAction>(
      _clearTileStateMapReducer),
  TypedReducer<HashMap<TileKey, TileState>, PhotoProcessedAction>(
      _updateTileMapWithSudokuReducer),
...
HashMap<TileKey, TileState> _tileSelectedReducer(
  ...
  final HashMap<TileKey, TileState> newTileStateMap =
      HashMap<TileKey, TileState>();
...
HashMap<TileKey, TileState> _tileDeselectedReducer(
  ...
  tileStateMap.forEach((tileKey, tileState) {
    ...
    newTileStateMap[tileKey] =
        tileState.copyWith(isSelected: false, value: value);
  });
...
HashMap<TileKey, TileState> _loadExampleValues(
    ...
    LoadPlayScreenWithSudokuAction action) {
  ...
  tileStateMap.forEach((tileKey, tileState) {
    ...
    newTileStateMap[tileKey] =
        tileState.copyWith(value: value, isOriginalTile: isOriginalTile);
  });
...
HashMap<TileKey, TileState> _addPressedNumberToTile(
  ...
  tileStateMap.forEach((tileKey, tileState) {
    int value =
        (tileState.isSelected) ? action.pressedNumber.number : tileState.value;
    newTileStateMap[tileKey] =
        tileState.copyWith(value: value, isSelected: false);
  });
...
HashMap<TileKey, TileState> _updateTileMapWithSolvedSudokuReducer(
  ...
  action.solvedSudoku.tileStateMap.forEach((tileKey, tileState) {
    ...
    newTileStateMap[tileKey] =
        tileState.copyWith(value: tileState.value, isSelected: false);
  });
...
HashMap<TileKey, TileState> _clearTileStateMapReducer(
  ...
  tileStateMap.forEach((tileKey, tileState) {
    newTileStateMap[tileKey] = tileState.copyWith(
        value: -1, isSelected: false, isOriginalTile: false, isInvalid: false);
  });
...
HashMap<TileKey, TileState> _checkForInvalidTilesReducer(
    HashMap<TileKey, TileState> tileStateMap,
    CheckForInvalidTilesAction action) {
