...
void main() async {
  ...
  group('Screen navigation tests -', () {
    ...
    test(
        'pressing "SOLVE WITH CAMERA" button on HomeScreen brings us to the SolveWithCameraScreen',
        () async {
    ...
    test(
        'pressing "SOLVE WITH TOUCH" button on HomeScreen brings us to the SolveWithTouchScreen',
        () async {
    ...
    test(
        'pressing "JUST PLAY" button on HomeScreen brings us to the JustPlayScreen',
        () async {
    ...
    test(
        'pressing "Help" on SolveWithCameraScreen takes you to SolveWithCameraHelpScreen',
        () async {
      await driver.tap(find.text(MyStrings.solveWithCameraButtonText));
    ...
    test(
        'pressing "Help" on SolveWithTouchScreen takes you to SolveWithTouchHelpScreen',
        () async {
      await driver.tap(find.text(MyStrings.solveWithTouchButtonText));
    ...
    test('pressing "Help" on JustPlayScreen takes you to JustPlayHelpScreen',
        () async {
      await driver.tap(find.text(MyStrings.justPlayButtonText));
